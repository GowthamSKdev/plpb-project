  ...
  return (
    <div className="relative flex h-[90vh] flex-col p-2">
      ...
      <div className="flex flex-shrink-0 items-center justify-between bg-white p-4">
        ...
        <button
          className="group to-primary relative flex items-center justify-center gap-2 overflow-hidden rounded-full bg-gradient-to-r from-blue-600 px-6 py-3 font-semibold text-white transition-all duration-300"
      ...
      {OpenCreateBlog && (
        <CreateBlog handleSubmit={handleSubmit} setOpenCreateBlog={setOpenCreateBlog} />
      )}
      {OpenUpdateBlog && (
        <UpdateBlog
