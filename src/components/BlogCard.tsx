...
export const BlogCard = ({ blog }: BlogCardProps) => {
  ...
  return (
    <div 
      className="bg-white overflow-hidden hover:shadow-lg transition-shadow duration-300 w-full max-w-sm sm:max-w-none" 
      style={{ 
    ...
    >
      ...
      <div className="px-4 sm:px-6 pb-4 sm:pb-6 pt-4 sm:pt-6 flex-1 flex flex-col">
        ...
        <button
          ...
          className="text-gray-900 font-bold text-sm sm:text-base hover:text-gray-700 transition-colors duration-200 mt-auto text-left flex items-center"
        >
